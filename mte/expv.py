...
'''
Implementation of Roger Sidje's Krylov matrix exponentiation 
algorithm. This file is based on 'expv.m' in
expokit (https://www.maths.uq.edu.au/expokit/), implemented 
in Python by Zach Fox (zachrfox@gmail.com).
'''
